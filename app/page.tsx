...
export default function Page() {
  ...
  return <main className="min-h-screen bg-[#0b0c0f] text-[#f7f3ea] selection:bg-[#d7aa45]/30">
    <header className="relative z-30 flex h-20 items-center justify-between border-b border-white/[0.07] bg-[#0b0c0f]/90 px-5 backdrop-blur-xl sm:px-8 lg:px-12">
      <div className="flex items-center gap-3"><button aria-label="Open menu" className="rounded-full p-2 text-white/55 lg:hidden"><Menu /></button><div className="flex size-10 items-center justify-center rounded-xl border border-[#d6a943]/45 bg-[#d6a943]/10 text-[#e4bd65]"><Navigation className="size-5 fill-current" /></div><div><div className="font-serif text-2xl font-bold tracking-tight text-[#f0c967]">Ooo <span className="text-white">Rickshaw</span></div><div className="-mt-1 text-[9px] uppercase tracking-[.25em] text-white/40">Har sawari khaas hoti hai</div></div></div>
